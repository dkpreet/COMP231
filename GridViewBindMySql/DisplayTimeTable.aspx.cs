        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["section_Id"] != null) {
                    ...
                    conn.Open();
                    MySqlCommand cmd = new MySqlCommand("SELECT a.*,b.*,c.* FROM section a, course b, timeslot c where a.section_id and a.course_id = b.course_id and a.slot_id = c.slot_id and a.section_id in ("+section_Id+")  ", conn);
